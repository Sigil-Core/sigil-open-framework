...
Sigil Lex parses a strict structured Markdown format. A 1.x policy requires an enforceable EVM, tool-call, custom, or model-budget rule. A 2.0 policy may also consist of enforced `## soft_limits`. Unknown fields are rejected at parse time. The `## signature` block at the end is generated by Sigil Warrant; do not edit it manually.
