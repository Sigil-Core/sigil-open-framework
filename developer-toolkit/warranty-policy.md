...
- **Manual Warrant** — write your policy directly in the `warranty.md` format. Full control over every field. For developers familiar with the Sigil Lex schema.

Both paths produce an identical signed `warranty.md` that Sigil Lex accepts at boot.
